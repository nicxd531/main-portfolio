...
const OtherLiabries = () => {
    ...
    return (
        <>
            <Paper sx={{overflow:"hidden", width: "90%", margin: "auto", mt: 2, height: { xs: "930px", lg: "380px" }, p: {xs:3,lg:4}, boxSizing: "border-box", display: "flex", flexDirection: { xs: "column", lg: "row" } }}>
